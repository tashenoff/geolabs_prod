...
class ParticleAnimation {
    ...
    drawCircle(circle1, update = false) {
        const { x , y , translateX , translateY , size , alpha  } = circle1;
        ...
        if (!update) this.circles.push(circle1);
    }
    clearContext() {
...
//# sourceMappingURL=contact.8733e008.js.map
